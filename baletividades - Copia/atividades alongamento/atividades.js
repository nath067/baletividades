...
botao_postar_atv.onclick = async function () {
    ...
    dadosForm.append('tipo_atividade', 'alongamento'); // Adicionando o tipo "centro" à atividade
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const tipo_atividade = 'alongamento';  // Este valor pode ser dinâmico com base no contexto da página
